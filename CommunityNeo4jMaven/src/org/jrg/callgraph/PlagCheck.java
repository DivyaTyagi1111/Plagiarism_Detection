...
public class PlagCheck {
	...
	Transaction tx= null;
	public float similarity_call_graph;
...
//		}
		...
		if(common.size() == 0)
		{
			similarity_call_graph = 0;
			System.out.println("Similarity percentage at call graph = "+ 0 +"%");
		}
		else
		{
			similarity_call_graph = (100*common.size())/alist1.size();
			System.out.println("Similarity percentage at call graph = "+ (100*common.size())/alist1.size() +"%");
		}
